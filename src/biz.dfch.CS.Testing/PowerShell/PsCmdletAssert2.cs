...
namespace biz.dfch.CS.Testing.PowerShell
{
    public class PsCmdletAssert2
    {
        ...
        public PsCmdletAssert2()
            : this(new List<SessionStateVariableEntry>())
        {
            // N/A
        }

        public PsCmdletAssert2(IDictionary<string, object> variableEntries)
        ...
        public PsCmdletAssert2(IEnumerable<SessionStateVariableEntry> variableEntries)
        {
            Contract.Requires(null != variableEntries);
        ...
        public IList<PSObject> Invoke(Type cmdletType, Dictionary<string, object> parameters, Func<Exception, Exception> exceptionHandler)
        {
            Contract.Requires(null != cmdletType);
            Contract.Requires(null != parameters);
            Contract.Ensures(null != Contract.Result<IList<PSObject>>());
        ...
        public IList<PSObject> Invoke(Type cmdletType, Dictionary<string, object> parameters, Func<Exception, Exception> exceptionHandler, Action<IList<ErrorRecord>> errorHandler)
        {
            Contract.Requires(null != cmdletType);
            Contract.Requires(null != parameters);
            Contract.Ensures(null != Contract.Result<IList<PSObject>>());
        ...
        public IList<PSObject> Invoke(Type cmdletType, Dictionary<string, object> parameters, Action<IList<ErrorRecord>> errorHandler)
        {
            Contract.Requires(null != cmdletType);
            Contract.Requires(null != parameters);
            Contract.Ensures(null != Contract.Result<IList<PSObject>>());
        ...
        public IList<PSObject> Invoke(Type cmdletType, Dictionary<string, object> parameters, string helpFileName, Func<Exception, Exception> exceptionHandler, Action<IList<ErrorRecord>> errorHandler)
        {
            Contract.Requires(null != cmdletType);
            Contract.Requires(null != parameters);
            Contract.Requires(!string.IsNullOrWhiteSpace(helpFileName));
        ...
        public void HasOutputType(Type implementingType, string expectedOutputTypeName, string parameterSetName, string message)
        {
            Contract.Requires(null != implementingType);
            Contract.Requires(!string.IsNullOrWhiteSpace(expectedOutputTypeName));
